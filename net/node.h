...
namespace Net
{
	...
	*/
	...
	TMPL	void			sendArray(UINT16 channel, BYTE flags, const Array<C>&data);			//!< Starts a new transfer \param channel Target channel to send on \param flags Package flags \param data Const reference to a data array
	...
	TMPL	void			sendArray(UINT16 channel, const Array<C>&data);			//!< Starts a new transfer. Implies NET_CONFIRM|NET_SERIAL  \param channel Target channel to send on \param data Const reference to a data array
	...
	TMPL	void			sendArray(UINT16 channel, BYTE flags, const Array<C>&data);			//!< Starts a new transfer to \b all clients (mutex protected) \param channel Target channel to send on \param flags Package flags \param data Reference to the transfer data
	...
	TMPL	void			sendArray(UINT16 channel, const Array<C>&data);						//!< Starts a new transfer to \b all clients (mutex protected). Implies NET_CONFIRM|NET_SERIAL  \param channel Target channel to send on \param flags Package flags \param data Reference to the transfer data
