...
//	Thanks to Lee Bode for catching a bug in MfcappView::OnFileGetdimensionsjpg() 
//
////////////////////////////////////////////////////////////
//
//	General Usage:
...
public:
	...
	static BYTE * JpegFileToRGB(C_String fileName,			// path to image
	...
	static BOOL RGBToJpegFile(C_String fileName,				// path
