...
class QuantDlg : public Dialog
{
// Construction
public:
	QuantDlg(Wnd* pParent = NULL);   // standard constructor
...
// Overrides
	...
	//{{AFX_VIRTUAL(QuantDlg)
	protected:
	virtual void DoDataExchange(DataExchange* pDX);    // DDX/DDV support
	//}}AFX_VIRTUAL
