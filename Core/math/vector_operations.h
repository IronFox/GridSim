...
namespace Vec
{
	...
	template <typename T0, typename T1>
		...
		{
			T0 result = fabs(__p0[0]-__p1[0]);
			for (register index_t iterator__ = 1; iterator__ < dimensions; iterator__++)
				result = vmax(result,fabs(__p0[iterator__]-__p1[iterator__]));
			return result;
		}
	...
	*/
	template <typename T0>
		...
		{
			return sqrt((Vec::Operator1_sumD(v, dimensions)/*v:i*v:i*/));
		}
	...
	*/
	template <typename T0, typename T1>
		...
		{
			return Vec::Operator4_sumD(v, w, dimensions)/*Math::sqr(v:i - w:i)*/;
		}
	...
	*/
	template <typename T0, typename T1>
		...
		{
			return sqrt( (Vec::Operator4_sumD(v, w, dimensions)/*Math::sqr(v:i - w:i)*/) );
		}
	...
	*/
	template <typename T0, typename T1, typename T2>
		...
		{
			return Vec::Operator6_sumD(v, w, tolerance, dimensions)/*Math::sqr(v:i - w:i)*/ < tolerance*tolerance;
		}
	...
	*/
	template <typename T0, typename T1>
		...
		{
			return (Vec::Operator6_sumD(v, w, (TypeInfo<T0>::error), dimensions)/*Math::sqr(v:i - w:i)*/ < (TypeInfo<T0>::error)*(TypeInfo<T0>::error));
		}
	...
	*/
	template <typename T0, typename T1>
		...
		{
			using std::fabs;
			return Vec::Functional7_maxD(v, w, dimensions)/*fabs(v:i-w:i)*/;
		}
	...
	*/
	template <typename T0, typename T1, typename T2>
		...
		{
			return ((Vec::Operator0_sumD(p, normal, dimensions)/*p:i*normal:i*/) - (Vec::Operator0_sumD(base, normal, dimensions)/*base:i*normal:i*/)) / (sqrt((Vec::Operator1_sumD(normal, dimensions)/*normal:i*normal:i*/)));
		}
	...
	*/
	template <typename T0, typename T1, typename T2>
		...
		{
			T2 len = (sqrt( (Vec::Operator4_sumD(current, center, dimensions)/*Math::sqr(current:i - center:i)*/) ));
	...
	*/
	template <typename T0>
		...
		{
			T0 len = sqrt((Vec::Operator1_sumD(vector, dimensions)/*vector:i*vector:i*/));
			for (register index_t iterator__=0; iterator__ < dimensions; iterator__++)
			{
	...
	*/
	template <typename T0>
		inline	void	__fastcall	absD(T0 *v, count_t dimensions)throw()
		{
			...
			for (register index_t iterator__=0; iterator__ < dimensions; iterator__++)
			{
				v[iterator__] = fabs(v[iterator__]);
			}
		}
	...
	*/
	template <typename T0, typename T1>
		...
		{
			T0 len = sqrt( (Vec::Operator1_sumD(current, dimensions)/*current:i*current:i*/) );
			T0 fc = T0(length)/len;
	...
	*/
	template <typename T0, typename T1>
		...
		{
			return acos(Math::clamp((Vec::Operator0_sumD(v, w, dimensions)/*v:i*w:i*/)/((sqrt((Vec::Operator1_sumD(v, dimensions)/*v:i*v:i*/)))*(sqrt((Vec::Operator1_sumD(w, dimensions)/*w:i*w:i*/)))),-1,1))*180/M_PI;
		}
	...
	*/
	template <typename T0, typename T1>
		...
		{
			return (Vec::Operator0_sumD(v, w, dimensions)/*v:i*w:i*/)/((sqrt((Vec::Operator1_sumD(v, dimensions)/*v:i*v:i*/)))*(sqrt((Vec::Operator1_sumD(w, dimensions)/*w:i*w:i*/))));
		}
	...
	*/
	template <typename T0, typename T1, typename T2>
		inline	void	__fastcall	clampD(T0 *v, T1 min, T2 max, count_t dimensions)throw()
		{
			for (register index_t iterator__=0; iterator__ < dimensions; iterator__++)
			{
				v[iterator__] = M::clamped(v[iterator__],min,max);
			}
		}
	...
	*/
	template <typename T0, typename T1, typename T2>
		inline	void	__fastcall	maxD(const T0 *v, const T1 *w, T2 *result, count_t dimensions)throw()
		{
			...
			for (register index_t iterator__=0; iterator__ < dimensions; iterator__++)
			{
				result[iterator__] = Max( v[iterator__], w[iterator__]);
			}
		}
	...
	*/
	template <typename T0, typename T1, typename T2>
		inline	void	__fastcall	minD(const T0 *v, const T1 *w, T2 *result, count_t dimensions)throw()
		{
			...
			for (register index_t iterator__=0; iterator__ < dimensions; iterator__++)
			{
				result[iterator__] = Min( v[iterator__], w[iterator__]);
			}
		}
	...
	*/
	template <typename T0, typename T1, typename T2, typename T3>
		inline	T3	__fastcall	interceptD(const T0 *position, const T1 *velocity, T2 interception_velocity, T3 *result, count_t dimensions)throw()
		{
			...
			{
				T3 len = sqrt((Vec::Operator1_sumD(result, dimensions)/*result:i*result:i*/));
				for (register index_t iterator__=0; iterator__ < dimensions; iterator__++)
				{
					result[iterator__] /= len;
				}
	...
	*/
	template <typename T0, typename T1>
		...
		{
			return Math::sqr(v.x - w.x) + Math::sqr(v.y - w.y) + Math::sqr(v.z - w.z);
		}
	...
	*/
	template <typename T0, typename T1>
		...
		{
			return sqrt( (Math::sqr(v.x - w.x) + Math::sqr(v.y - w.y) + Math::sqr(v.z - w.z)) );
		}
	...
	*/
	template <typename T0, typename T1, typename T2>
		...
		{
			return Math::sqr(v.x - w.x) + Math::sqr(v.y - w.y) + Math::sqr(v.z - w.z) < tolerance*tolerance;
		}
	...
	*/
	template <typename T0, typename T1>
		...
		{
			return (Math::sqr(v.x - w.x) + Math::sqr(v.y - w.y) + Math::sqr(v.z - w.z) < (TypeInfo<T0>::error)*(TypeInfo<T0>::error));
		}
	...
	*/
	template <typename T0, typename T1>
		...
		{
			using std::fabs;
			return vmax(fabs(v.x-w.x), vmax(fabs(v.y-w.y), fabs(v.z-w.z)));
		}
	...
	*/
	template <typename T0, typename T1, typename T2>
		...
		{
			return ((p.x*normal.x + p.y*normal.y + p.z*normal.z) - (base.x*normal.x + base.y*normal.y + base.z*normal.z)) / (sqrt((normal.x*normal.x + normal.y*normal.y + normal.z*normal.z)));
		}
	...
	*/
	template <typename T0, typename T1, typename T2>
		...
		{
			T2 len = (sqrt( (Math::sqr(current.x - center.x) + Math::sqr(current.y - center.y) + Math::sqr(current.z - center.z)) ));
	...
	*/
	template <typename T0>
		...
		{
			T0 len = sqrt((vector.x*vector.x + vector.y*vector.y + vector.z*vector.z));
			vector.x /= len;
			vector.y /= len;
			vector.z /= len;
		}
	...
	*/
	template <typename T0, typename T1>
		...
		{
			T0 len = sqrt( (current.x*current.x + current.y*current.y + current.z*current.z) );
			T0 fc = T0(length)/len;
	...
	*/
	template <typename T0, typename T1>
		...
		{
			return acos(Math::clamp((v.x*w.x + v.y*w.y + v.z*w.z)/((sqrt((v.x*v.x + v.y*v.y + v.z*v.z)))*(sqrt((w.x*w.x + w.y*w.y + w.z*w.z)))),-1,1))*180/M_PI;
		}
	...
	*/
	template <typename T0, typename T1>
		...
		{
			return (v.x*w.x + v.y*w.y + v.z*w.z)/((sqrt((v.x*v.x + v.y*v.y + v.z*v.z)))*(sqrt((w.x*w.x + w.y*w.y + w.z*w.z))));
		}
	...
	*/
	template <typename T0, typename T1, typename T2>
		...
		{
			result.y = sin(height_angle);
			T2	r2 = cos(height_angle);
			result.x = cos(planar_angle)*r2;
			result.z = sin(planar_angle)*r2;
		}
	...
	*/
	template <typename T0, typename T1, typename T2, typename T3>
		inline	T3	__fastcall	intercept(const M::TVec2<T0>& position, const M::TVec2<T1>& velocity, T2 interception_velocity, M::TVec2<T3>& result)throw()
		{
			...
			{
				T3 len = sqrt((result.x*result.x + result.y*result.y));
				result.x /= len;
				result.y /= len;
			};
			return t;
	...
	*/
	template <typename T0, typename T1, typename T2, typename T3>
		inline	T3	__fastcall	intercept(const TVec3<T0>& position, const TVec3<T1>& velocity, T2 interception_velocity, TVec3<T3>& result)throw()
		{
			...
			{
				T3 len = sqrt((result.x*result.x + result.y*result.y + result.z*result.z));
				result.x /= len;
				result.y /= len;
				result.z /= len;
			};
	...
	*/
	template <typename T0, typename T1, typename T2, typename T3>
		inline	T3	__fastcall	intercept(const M::TVec4<T0>& position, const M::TVec4<T1>& velocity, T2 interception_velocity, M::TVec4<T3>& result)throw()
		{
			...
			{
				T3 len = sqrt((result.x*result.x + result.y*result.y + result.z*result.z + result.w*result.w));
				result.x /= len;
				result.y /= len;
				result.z /= len;
				result.w /= len;
	...
	public:
		...
		*/
		template <typename T0, typename T1, typename T2>
			...
			{
				v[Current] = M::clamped(v[Current],min,max);
			}
		...
		*/
		template <typename T0, typename T1, typename T2>
			...
			{
				v.v[Current] = M::clamped(v.v[Current],min,max);
			}
		...
		*/
		...
		template <typename T0>
			static inline	void	__fastcall	User30_abs(T0 __p0[Dimensions])throw()
			{
				__p0[Current] = fabs(__p0[Current]);
			}

		template <typename T0>
			static inline	bool	__fastcall	LogicOperator31_or(const T0 __p0[Dimensions])throw()
			{
				return isnan(__p0[Current]);
			}

		template <typename T0>
			static inline	T0	__fastcall	Functional32_min(const T0 __p0[Dimensions])throw()
			{
				return __p0[Current];
			}

		template <typename T0>
			static inline	T0	__fastcall	Functional33_max(const T0 __p0[Dimensions])throw()
			{
				return __p0[Current];
			}
		...
		template <typename T0, typename T1>
			static inline	bool	__fastcall	LogicOperator36_or(const T0 __p0[Dimensions], const T1 __p1[Dimensions])throw()
			{
				return __p0[Current] < __p1[Current];
			}

		template <typename T0, typename T1>
			static inline	bool	__fastcall	LogicOperator37_or(const T0 __p0[Dimensions], const T1 __p1[Dimensions])throw()
			{
				return __p0[Current] > __p1[Current];
			}

		template <typename T0, typename T1>
			static inline	bool	__fastcall	LogicOperator38_and(const T0 __p0[Dimensions], const T1 __p1[Dimensions])throw()
			{
				return __p0[Current] < __p1[Current];
			}

		template <typename T0, typename T1>
			static inline	bool	__fastcall	LogicOperator39_and(const T0 __p0[Dimensions], const T1 __p1[Dimensions])throw()
			{
				return __p0[Current] > __p1[Current];
			}
...
template <count_t Current, count_t Dimensions>
	...
	public:
		...
		/* --- Now processing 'Pointers/Functional:vmax||const [*]|const [*]|<>|fabs(v:i-w:i)' --- */
		template <typename T0, typename T1>
			static inline	T0	__fastcall	Functional29_max(const T0 __p0[Dimensions], const T1 __p1[Dimensions])throw()
			{
				return vmax(
		...
		/* --- Now processing 'Pointers/User:||[*]|<>|__p0:i = fabs(__p0:i);' --- */
		template <typename T0>
			static inline	void	__fastcall	User30_abs(T0 __p0[Dimensions])throw()
			{
				__p0[Current] = fabs(__p0[Current]);
				VecV_Include__<Current+1,Dimensions, GreaterOrEqual<Current+2,Dimensions>::eval>::User30_abs(__p0);
			}
		...
		template <typename T0>
			static inline	bool	__fastcall	LogicOperator31_or(const T0 __p0[Dimensions])throw()
			{
				return (
						isnan(__p0[Current]) ||
						VecV_Include__<Current+1,Dimensions, GreaterOrEqual<Current+2,Dimensions>::eval>::LogicOperator31_or(__p0)
					);
			}
		...
		template <typename T0>
			static inline	T0	__fastcall	Functional32_min(const T0 __p0[Dimensions])throw()
			{
				return vmin(
						__p0[Current],
						VecV_Include__<Current+1,Dimensions, GreaterOrEqual<Current+2,Dimensions>::eval>::Functional32_min(__p0)
					);
			}
		...
		template <typename T0>
			static inline	T0	__fastcall	Functional33_max(const T0 __p0[Dimensions])throw()
			{
				return vmax(
						__p0[Current],
						VecV_Include__<Current+1,Dimensions, GreaterOrEqual<Current+2,Dimensions>::eval>::Functional33_max(__p0)
					);
			}


		/* --- Now processing 'Pointers/User:||const [*]|const [*]|[*]|<>|__p2:i = Max( __p0:i, __p1:i);' --- */
		template <typename T0, typename T1, typename T2>
			static inline	void	__fastcall	User34_max(const T0 __p0[Dimensions], const T1 __p1[Dimensions], T2 __p2[Dimensions])throw()
			{
				__p2[Current] = Max( __p0[Current], __p1[Current]);
		...
		/* --- Now processing 'Pointers/User:||const [*]|const [*]|[*]|<>|__p2:i = Min( __p0:i, __p1:i);' --- */
		template <typename T0, typename T1, typename T2>
			static inline	void	__fastcall	User35_min(const T0 __p0[Dimensions], const T1 __p1[Dimensions], T2 __p2[Dimensions])throw()
			{
				__p2[Current] = Min( __p0[Current], __p1[Current]);
		...
		template <typename T0, typename T1>
			static inline	bool	__fastcall	LogicOperator36_or(const T0 __p0[Dimensions], const T1 __p1[Dimensions])throw()
			{
				return (
						__p0[Current] < __p1[Current] ||
						VecV_Include__<Current+1,Dimensions, GreaterOrEqual<Current+2,Dimensions>::eval>::LogicOperator36_or(__p0,__p1)
					);
			}
		...
		template <typename T0, typename T1>
			static inline	bool	__fastcall	LogicOperator37_or(const T0 __p0[Dimensions], const T1 __p1[Dimensions])throw()
			{
				return (
						__p0[Current] > __p1[Current] ||
						VecV_Include__<Current+1,Dimensions, GreaterOrEqual<Current+2,Dimensions>::eval>::LogicOperator37_or(__p0,__p1)
					);
			}
		...
		template <typename T0, typename T1>
			static inline	bool	__fastcall	LogicOperator38_and(const T0 __p0[Dimensions], const T1 __p1[Dimensions])throw()
			{
				return (
						__p0[Current] < __p1[Current] &&
						VecV_Include__<Current+1,Dimensions, GreaterOrEqual<Current+2,Dimensions>::eval>::LogicOperator38_and(__p0,__p1)
					);
			}
		...
		template <typename T0, typename T1>
			static inline	bool	__fastcall	LogicOperator39_and(const T0 __p0[Dimensions], const T1 __p1[Dimensions])throw()
			{
				return (
						__p0[Current] > __p1[Current] &&
						VecV_Include__<Current+1,Dimensions, GreaterOrEqual<Current+2,Dimensions>::eval>::LogicOperator39_and(__p0,__p1)
					);
			}
		...
		*/
		template <typename T0>
			...
			{
				return sqrt((VecV_Include__<0,Dimensions,false>::Operator18_sum(v)/*v:i*v:i*/));
			}
		...
		*/
		template <typename T0, typename T1>
			...
			{
				return VecV_Include__<0,Dimensions,false>::Operator21_sum(v, w)/*Math::sqr(v:i - w:i)*/;
			}
		...
		*/
		template <typename T0, typename T1>
			...
			{
				return sqrt( (VecV_Include__<0,Dimensions,false>::Operator21_sum(v, w)/*Math::sqr(v:i - w:i)*/) );
			}
		...
		*/
		template <typename T0, typename T1, typename T2>
			...
			{
				return VecV_Include__<0,Dimensions,false>::Operator28_sum(v, w, tolerance)/*Math::sqr(v:i - w:i)*/ < tolerance*tolerance;
			}
		...
		*/
		template <typename T0, typename T1>
			...
			{
				return (VecV_Include__<0,Dimensions,false>::Operator28_sum(v, w, (TypeInfo<T0>::error))/*Math::sqr(v:i - w:i)*/ < (TypeInfo<T0>::error)*(TypeInfo<T0>::error));
			}
		...
		*/
		template <typename T0, typename T1>
			...
			{
				using std::fabs;
				return VecV_Include__<0,Dimensions,false>::Functional29_max(v, w)/*fabs(v:i-w:i)*/;
			}
		...
		*/
		template <typename T0, typename T1, typename T2>
			...
			{
				return ((VecV_Include__<0,Dimensions,false>::Operator17_sum(p, normal)/*p:i*normal:i*/) - (VecV_Include__<0,Dimensions,false>::Operator17_sum(base, normal)/*base:i*normal:i*/)) / (sqrt((VecV_Include__<0,Dimensions,false>::Operator18_sum(normal)/*normal:i*normal:i*/)));
			}
		...
		*/
		template <typename T0, typename T1, typename T2>
			...
			{
				T2 len = (sqrt( (VecV_Include__<0,Dimensions,false>::Operator21_sum(current, center)/*Math::sqr(current:i - center:i)*/) ));
		...
		*/
		template <typename T0>
			...
			{
				T0 len = sqrt((VecV_Include__<0,Dimensions,false>::Operator18_sum(vector)/*vector:i*vector:i*/));
		...
		*/
		template <typename T0>
			...
			{
				using std::fabs;
				VecV_Include__<0,Dimensions,false>::User30_abs(v);
			}
		...
		*/
		template <typename T0, typename T1>
			...
			{
				T0 len = sqrt( (VecV_Include__<0,Dimensions,false>::Operator18_sum(current)/*current:i*current:i*/) );
				T0 fc = T0(length)/len;
		...
		*/
		template <typename T0, typename T1>
			...
			{
				return acos(Math::clamp((VecV_Include__<0,Dimensions,false>::Operator17_sum(v, w)/*v:i*w:i*/)/((sqrt((VecV_Include__<0,Dimensions,false>::Operator18_sum(v)/*v:i*v:i*/)))*(sqrt((VecV_Include__<0,Dimensions,false>::Operator18_sum(w)/*w:i*w:i*/)))),-1,1))*180/M_PI;
			}
		...
		*/
		template <typename T0>
			...
			{
				return VecV_Include__<0,Dimensions,false>::LogicOperator31_or(v)/*isnan(v:i)*/;
			}
		...
		*/
		template <typename T0, typename T1>
			...
			{
				return (VecV_Include__<0,Dimensions,false>::Operator17_sum(v, w)/*v:i*w:i*/)/((sqrt((VecV_Include__<0,Dimensions,false>::Operator18_sum(v)/*v:i*v:i*/)))*(sqrt((VecV_Include__<0,Dimensions,false>::Operator18_sum(w)/*w:i*w:i*/))));
			}
		...
		*/
		template <typename T0>
			...
			{
				return VecV_Include__<0,Dimensions,false>::Functional32_min(v)/*v:i*/;
			}
		...
		*/
		template <typename T0>
			...
			{
				return VecV_Include__<0,Dimensions,false>::Functional33_max(v)/*v:i*/;
			}
		...
		*/
		template <typename T0, typename T1, typename T2>
			...
			{
				using Math::Max;
				VecV_Include__<0,Dimensions,false>::User34_max(v, w, result);
			}
		...
		*/
		template <typename T0, typename T1, typename T2>
			...
			{
				using Math::Min;
				VecV_Include__<0,Dimensions,false>::User35_min(v, w, result);
			}
		...
		*/
		template <typename T0, typename T1>
			...
			{
				return VecV_Include__<0,Dimensions,false>::LogicOperator36_or(v, w)/*v:i < w:i*/;
			}
		...
		*/
		template <typename T0, typename T1>
			...
			{
				return VecV_Include__<0,Dimensions,false>::LogicOperator37_or(v, w)/*v:i > w:i*/;
			}
		...
		*/
		template <typename T0, typename T1>
			...
			{
				return VecV_Include__<0,Dimensions,false>::LogicOperator38_and(v, w)/*v:i < w:i*/;
			}
		...
		*/
		template <typename T0, typename T1>
			...
			{
				return VecV_Include__<0,Dimensions,false>::LogicOperator39_and(v, w)/*v:i > w:i*/;
			}
		...
		*/
		template <typename T0, typename T1, typename T2, typename T3>
			static	inline	T3	__fastcall	intercept(const T0 position[Dimensions], const T1 velocity[Dimensions], T2 interception_velocity, T3 result[Dimensions])throw()
			{
				...
				{
					T3 len = sqrt((VecV_Include__<0,Dimensions,false>::Operator18_sum(result)/*result:i*result:i*/));
					VecV_Include__<0,Dimensions,false>::User26_normalize0(result, len);
				};
				return t;
			}
