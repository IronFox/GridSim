	...
	*/
	namespace Math
	{
		...
		*/
		...
		MFUNC3	(C0)		Clamp(C0 v, C1 min, C2 max) {return clamp(v,min,max);}
...
namespace std
{
	...
	template <>
	class numeric_limits < DeltaWorks::THalf >
		#if SYSTEM == WINDOWS
	...
	template <>
	class numeric_limits < DeltaWorks::half >
		: public numeric_limits<DeltaWorks::THalf>
	{
	public:
