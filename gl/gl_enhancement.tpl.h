...
#define DEFINE_OPENGL_TYPE(TYPE,TYPE_NAME, A_TYPE, LA_TYPE, RGB_TYPE, RGBA_TYPE)\
	template <>\
		struct GLType<TYPE>\
		{\
			typedef TYPE		Type;\
...
//					OGL typedef	| OGL type const	| 1 channel texel	| 2 channels texel			| 3 channels	| 4 channels
DEFINE_OPENGL_TYPE(	GLbyte,		GL_BYTE,			GL_ALPHA8,			GL_LUMINANCE8_ALPHA8,		GL_RGB8,		GL_RGBA8);
DEFINE_OPENGL_TYPE(	GLubyte,	GL_UNSIGNED_BYTE,	GL_ALPHA8,			GL_LUMINANCE8_ALPHA8,		GL_RGB8,		GL_RGBA8);
DEFINE_OPENGL_TYPE(	GLshort,	GL_SHORT,			GL_ALPHA16,			GL_LUMINANCE16_ALPHA16,		GL_RGB16,		GL_RGBA16);
DEFINE_OPENGL_TYPE(	GLushort,	GL_UNSIGNED_SHORT,	GL_ALPHA16,			GL_LUMINANCE16_ALPHA16,		GL_RGB16,		GL_RGBA16);
DEFINE_OPENGL_TYPE(	GLint,		GL_INT,				GL_ALPHA32I_EXT,	GL_LUMINANCE16_ALPHA16,		GL_RGB32I,		GL_RGBA32I);	
DEFINE_OPENGL_TYPE(	GLuint,		GL_UNSIGNED_INT,	GL_ALPHA32UI_EXT,	GL_LUMINANCE16_ALPHA16,		GL_RGB32UI,		GL_RGBA32UI);
DEFINE_OPENGL_TYPE(	GLfloat,	GL_FLOAT,			GL_ALPHA16F_ARB,	GL_LUMINANCE_ALPHA16F_ARB,	GL_RGB16F_ARB,	GL_RGBA16F_ARB);
DEFINE_OPENGL_TYPE(	GLdouble,	GL_DOUBLE,			GL_ALPHA32F_ARB,	GL_LUMINANCE_ALPHA32F_ARB,	GL_RGB32F_ARB,	GL_RGBA32F_ARB);

DEFINE_OPENGL_TYPE( GLDepthComponent, GL_FLOAT,		GL_DEPTH_COMPONENT24,	GL_DEPTH_COMPONENT24,	GL_DEPTH_COMPONENT24,	GL_DEPTH_COMPONENT24);
