...
namespace Engine
{
	...
	*/
	...
	virtual						~Keyboard();
			...
			void				FilterAppend(const char*strn);		//!< Appends the specified string to the internal character buffer. Only characters passing the character filter are considered. \param strn String to append. Only up to 255 characters are copied.
